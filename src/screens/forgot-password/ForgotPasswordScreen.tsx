...
import { ForgotPassword } from '../../enum/forgotPasswordEnum';
      ...
      <S.Container>
        <S.WrapperForm>
          {step === ForgotPassword.FORGOT ? (
              <>
                <S.WrapperTitle>
                  <S.Title>Insira o endereço de e-mail que você usou quando se cadastrou e enviaremos instruções para redefinir a sua senha.</S.Title>
                </S.WrapperTitle>
                <S.WrapperInput>
                  <Input
            ...
            <>
                <S.WrapperTitle>
                  <S.Title>Para você conseguir o acesso novamente, digite o código enviado para seu e-mail e a nova senha</S.Title>
                </S.WrapperTitle>
                <S.WrapperInput>
                  <Input
